...
*/
export class BranchrestrictionAllOf {
    ...
    */
    'kind': BranchrestrictionAllOf.KindEnum;
    /**
    * Indicates how the restriction is matched against a branch. The default is `glob`.
    */
    'branchMatchKind': BranchrestrictionAllOf.BranchMatchKindEnum;
    /**
    ...
    */
    'branchType'?: BranchrestrictionAllOf.BranchTypeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "kind",
            "baseName": "kind",
            "type": "BranchrestrictionAllOf.KindEnum"
        },
        {
            "name": "branchMatchKind",
            "baseName": "branch_match_kind",
            "type": "BranchrestrictionAllOf.BranchMatchKindEnum"
        },
        {
            "name": "branchType",
            "baseName": "branch_type",
            "type": "BranchrestrictionAllOf.BranchTypeEnum"
        },
        {
            "name": "pattern",
            "baseName": "pattern",
    ...
    static getAttributeTypeMap() {
        return BranchrestrictionAllOf.attributeTypeMap;
    }
}

export namespace BranchrestrictionAllOf {
