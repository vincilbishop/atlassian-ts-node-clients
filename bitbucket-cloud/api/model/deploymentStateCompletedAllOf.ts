...
*/
export class DeploymentStateCompletedAllOf {
    /**
    * The name of deployment state (COMPLETED).
    */
    'name'?: DeploymentStateCompletedAllOf.NameEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "name",
            "baseName": "name",
            "type": "DeploymentStateCompletedAllOf.NameEnum"
        },
        {
            "name": "url",
            "baseName": "url",
    ...
    static getAttributeTypeMap() {
        return DeploymentStateCompletedAllOf.attributeTypeMap;
    }
}

export namespace DeploymentStateCompletedAllOf {
